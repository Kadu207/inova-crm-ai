# Catálogo de agentes — Inova CRM AI
...
```text
INÍCIO SESSÃO
  memory.md → agentes.md → AGENTS.md → constitution → baseline.md
...
| Tipo                          | Onde                               | Nota                                                                 |
| ----------------------------- | ---------------------------------- | -------------------------------------------------------------------- |
| Harness Cursor (este arquivo) | repo root + `.cursor/`             | orquestra humanos/agentes de build                                   |
| Agentes IA produto            | FastAPI `ai-crm` + `worker-crm-ai` | ver [`docs/agentes-ia.md`](docs/agentes-ia.md) — só via toolbelt API |
...
- Deploy CI: [`docs/operations/ci-docker-images.md`](docs/operations/ci-docker-images.md)
- Chatwoot VPS: [`docs/operations/vps-chatwoot-instances.md`](docs/operations/vps-chatwoot-instances.md)
- Índice harness: [`docs/harness.md`](docs/harness.md)
