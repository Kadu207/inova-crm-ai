...
| `/leads/[id]`         | `LeadDetailClient`        | Detalhe + edit + delete confirm                   |
| `/empresas`           | `CompaniesClient`         | Lista + modal create (`POST /companies`)          |
| `/empresas/[id]`      | `CompanyDetailClient`     | Detalhe + edit + delete confirm                   |
| `/contatos`           | `ContactsClient`          | Lista + modal create (`POST /contacts`)           |
| `/contatos/[id]`      | `ContactDetailClient`     | Detalhe + edit + delete confirm                   |
| `/produtos`           | `ProductsClient`          | Lista + modal create (`POST /products`)           |
| `/produtos/[id]`      | `ProductDetailClient`     | Detalhe + edit + delete confirm                   |
| `/servicos`           | `ServicesClient`          | Lista + modal create (`POST /services`)           |
| `/servicos/[id]`      | `ServiceDetailClient`     | Detalhe + edit + delete confirm                   |
| `/tarefas`            | `TasksClient`             | Lista + modal create (`POST /tasks`)              |
| `/tarefas/[id]`       | `TaskDetailClient`        | Detalhe + edit + delete confirm                   |
| `/oportunidades`      | `OpportunitiesClient`     | Lista + modal create (`POST /opportunities`)      |
| `/oportunidades/[id]` | `OpportunityDetailClient` | Detalhe + edit + won/lost + delete                |
